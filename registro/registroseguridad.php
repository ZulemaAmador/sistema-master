                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                                ...
                                                <div class="form-row " style="margin:20px 20px 10px 20px">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group"><label class="small mb-1" for="inputPassword"><b>Ingrese una contraseña</b> </label><input class="form-control py-4" id="registroclave1" type="text" name="clave_empleado1" autofocus maxlength="16" placeholder="Ingrese su contraseña" required/></div>
                                                        </div>
                                                        <div class="col-md-6">
